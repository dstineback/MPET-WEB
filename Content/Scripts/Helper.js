...
function OnControlsInitialized(s, e) {
    ASPxAnimationConstants.Durations.DEFAULT = 250;
}
...
function CreateMap(lat, long) {
    var mapOptions = {
        credentials: "AoQi8x29JLhh_iTsAec2pNK050bVHYJOI2G3sVgslKj0Bo1gP-nvP4263H4lFszY", // Credentials is taken from http://demos.devexpress.com/ASPxDockAndPopupsDemos/PopupControl/HeaderButtons.aspx
