...
<asp:Content ID="main" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="quickLinkButton">
        ...
        <asp:LinkButton runat="server" class="mainButton" ID="PlanJobBtn" href="Pages/PlannedJobs/PlannedJobs.aspx" OnClick="PlanJobBtn_Click" >Add Planned Job</asp:LinkButton>
        ...
        <asp:LinkButton runat="server" class="mainButton" ID="LinkButton1" href="Pages/Map/MapForm.aspx">Map</asp:LinkButton>
