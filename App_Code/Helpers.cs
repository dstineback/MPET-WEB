...
public static class PaletteHelper {
    ...
    //    Palette palette = CommonPallete;
    //    index = index % palette.Count;
    ...
    //    using(FileStream stream = new FileStream(HttpContext.Current.Server.MapPath(PalettePath), FileMode.Open, FileAccess.Read))
