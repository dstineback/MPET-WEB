...
namespace MpetDataModel.cs
{
    ...
    public partial class TemplateBaseTables : XPLiteObject
    {
        int fRecordID;
        [Key(true)]
        public int RecordID
        ...
        [Association(@"TemplateBaseTablesReferencesUserRightTemplates")]
        ...
        BaseTableList fBaseTableID;
        [Association(@"TemplateBaseTablesReferencesBaseTableList")]
        public BaseTableList BaseTableID
        {
            get { return fBaseTableID; }
            set { SetPropertyValue<BaseTableList>("BaseTableID", ref fBaseTableID, value); }
        }
        MPetUsers fCreatedBy;
        [Association(@"TemplateBaseTablesReferencesMPetUsers")]
        ...
        [Association(@"TemplateBaseTablesReferencesMPetUsers1")]
