...
namespace MpetDataModel.cs
{
    ...
    public partial class StoresIssueAlertDefaults : XPLiteObject
    {
        int fAlertID;
        [Key(true)]
        public int AlertID
        ...
        [Association(@"StoresIssueAlertDefaultsReferencesMPetUsers")]
        ...
        [Association(@"StoresIssueAlertDefaultsReferencesMPetUsers1")]
