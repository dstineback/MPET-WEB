...
namespace MpetDataModel.cs
{
    ...
    public partial class RequisitionAlertDefaults : XPLiteObject
    {
        int fAlertID;
        [Key(true)]
        public int AlertID
        ...
        [Association(@"RequisitionAlertDefaultsReferencesMPetUsers")]
        ...
        [Association(@"RequisitionAlertDefaultsReferencesMPetUsers1")]
