...
namespace MpetDataModel.cs
{
    ...
    public partial class StoreroomPartsAlertDefaults : XPLiteObject
    {
        int fAlertID;
        [Key(true)]
        public int AlertID
        ...
        [Association(@"StoreroomPartsAlertDefaultsReferencesMPetUsers")]
        ...
        [Association(@"StoreroomPartsAlertDefaultsReferencesMPetUsers1")]
